    ...
    <Stack width={{ xs: "100%" }} px={{ xs: 8 }}>
      <Stack>
        ...
        <Stack
          ...
          alignItems="center"
        >
          <Typography textTransform="capitalize" fontSize={{ xs: "1.6rem" }}>
            rating:
          </Typography>
                  ...
                  >
                    <StarIcon
                      sx={{
                        width: "100%",
                        height: "100%",
                        opacity: index >= itemRating ? 0.2 : 1,
                        color:
          ...
          {reviews.length === 0 && (
            <Typography fontSize={{ xs: "1.2rem" }}>(nothing yet)</Typography>
          )}
        </Stack>
        ...
        <Stack direction="row" spacing={{ xs: 3 }} alignItems="center">
          ...
          <Stack direction="row" spacing={2} mt={{ xs: 2 }} alignItems="center">
            {item.oldPrice !== 0 && (
              <Typography
                fontWeight="bold"
                fontSize={{ xs: "1.2rem" }}
            ...
            <Typography fontWeight="bold" fontSize={{ xs: "1.2rem" }}>
        ...
        <Button
          variant="contained"
          endIcon={
            <ShoppingCartRoundedIcon sx={{ width: "2rem", height: "1.5rem" }} />
          }
        ...
        <Button
          variant="outlined"
          endIcon={<FavoriteIcon sx={{ width: "2rem", height: "1.5rem" }} />}
