                        ...
                        >
                          <StarIcon
                            sx={{
                              ...
                              height: "100%",
                              opacity:
                                index >= Math.floor(review.rating) ? 0.2 : 1,
                              color:
      ...
      <Stack width="100%">
        ...
        <Stack direction="row" my={1} alignItems="center">
          {Array(5)
            ...
            .map((val, index) => {
              return (
                <Fragment key={`rating review start number ${index}`}>
                  <ReviewStar
                    index={index}
          ...
          {isSnackbarOpen && (
            <Typography fontSize={{ xs: "0.8rem" }} ml={2} color="error">
        ...
        <Button
          variant="contained"
          endIcon={<RateReviewIcon sx={{ width: "2rem", height: "1.5rem" }} />}
